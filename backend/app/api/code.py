...
========================
Local subprocess-based code execution with Monaco Editor.
"""
...
# ============ Supported Languages ============
SUPPORTED_LANGS = {"python", "python3", "cpp", "c++", "javascript", "js", "c", "java"}
...
async def submit_challenge(
    ...
    if language not in [l.lower() for l in challenge.supported_languages]:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail="Language not supported for this challenge"
        )
