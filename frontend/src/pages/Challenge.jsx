  ...
  return (
    <div className="h-screen flex flex-col bg-[#0a0a0f]">
        ...
        <div className="px-3 md:px-6 py-2 md:py-3 flex items-center justify-between">
          <div className="flex items-center gap-2 md:gap-4 min-w-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-sm md:text-[15px] font-semibold text-white tracking-tight truncate max-w-[140px] sm:max-w-none">{challenge.title}</h1>
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <div className={`md:w-1/3 bg-white/[0.02] md:border-r border-white/[0.06] overflow-auto ${mobilePanel === 'problem' ? 'flex-1' : 'hidden'} md:block md:flex-none`}>
          {/* Sidebar header */}
          <div className="sticky top-0 z-10 bg-white/[0.03] backdrop-blur-xl border-b border-white/[0.06] px-4 md:px-5 py-3 flex items-center gap-2">
        ...
        <div className={`flex-col ${mobilePanel === 'code' ? 'flex flex-1' : 'hidden'} md:flex md:flex-1`}>
          {/* Editor Header */}
          <div className="bg-white/[0.03] backdrop-blur-xl border-b border-white/[0.06] px-3 md:px-4 py-2 md:py-2.5 flex items-center justify-between flex-wrap gap-2">
